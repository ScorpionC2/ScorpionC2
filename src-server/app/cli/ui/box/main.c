...
void draw(int h, int w, const char color1[15], const char color2[15]) {
    ...
    printf(_PREFIX _MOD_FG "%d;%d;%d" _END B_TL_CORNER RESET, color.R, color.G,
           color.B);
    ...
    for (int i = 0; i < w; i++) {
        ...
        printf(_PREFIX _MOD_FG "%d;%d;%d" _END B_HORIZONTAL RESET, color.R,
               color.G, color.B);
    }
    ...
    for (int i = 0; i < h; i++) {
        ...
        printf(_PREFIX _MOD_FG "%d;%d;%d" _END B_VERTICAL RESET, color.R,
               color.G, color.B);
    ...
    printf(_PREFIX _MOD_FG "%d;%d;%d" _END B_BL_CORNER RESET, color.R, color.G,
           color.B);
